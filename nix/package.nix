...
stdenvNoCC.mkDerivation {
  ...
  version = "git-${shortRevision}${lib.optionalString (variant == "v3") "-v3"}";
  ...
  installPhase = ''
    ...
    # Upstream's universal runtime understands its DwarFS image. Nixpkgs'
    # appimageTools only extracts SquashFS, so preserve the executable intact.
  ...
  passthru = {
    ...
    officialRelease = metadata.officialRelease;
  ...
  meta = {
    ...
    downloadPage = "https://github.com/loonbac/citron-nextendo-nix/releases";
